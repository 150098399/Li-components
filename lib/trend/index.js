import { defineComponent as p, useSlots as f, computed as C, openBlock as n, createElementBlock as s, createElementVNode as a, normalizeStyle as c, unref as d, renderSlot as v, toDisplayString as g, createBlock as u, resolveDynamicComponent as i } from "vue";
const y = (e) => e.replace(/(A-Z)g/, "-$1").toLocaleLowerCase(), x = { class: "trend" }, m = { key: 1 }, S = { class: "icon" }, w = /* @__PURE__ */ p({
  ...
  setup(e) {
    const t = e, o = f(), l = C(() => t.type === "up" ? t.upTextColor : t.downTextColor);
...
const I = (e, t) => {
  ...
  for (const [l, r] of t)
    o[l] = r;
  return o;
}, k = /* @__PURE__ */ I(w, [["__scopeId", "data-v-35eb4a50"]]), h = {
  install(e) {
